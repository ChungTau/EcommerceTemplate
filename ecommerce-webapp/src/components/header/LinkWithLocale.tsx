...
export const LinkWithLocale = React.forwardRef<HTMLAnchorElement, LinkWithLocaleProps>(
    ({ locale, href, children }: LinkWithLocaleProps, ref) => {
        ...
        const linkClass = clsx("group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-md font-medium hover:bg-gray-100 hover:dark:bg-gray-100/[0.1]");
